...
CREATE TABLE `booking_details` (
  ...
  `RET_DT_TIME` timestamp NULL DEFAULT NULL,
...
('BLR', 'BANGALORE', 'MG ROAD', 'BANGALORE', 'KARNATAKA', 560005),
('MYS', 'MYSORE', 'JLB ROAD', 'MYSORE', 'KARNATAKA', 570008);
...
--
ALTER TABLE `billing_details`
  ADD CONSTRAINT `BILLINGFK1` FOREIGN KEY (`BOOKING_ID`) REFERENCES `booking_details` (`BOOKING_ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `booking_details`
--
ALTER TABLE `booking_details`
  ADD CONSTRAINT `BOOKINGFK1` FOREIGN KEY (`PICKUP_LOC`) REFERENCES `location_details` (`LOCATION_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `BOOKINGFK2` FOREIGN KEY (`DROP_LOC`) REFERENCES `location_details` (`LOCATION_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `BOOKINGFK3` FOREIGN KEY (`REG_NUM`) REFERENCES `car` (`REGISTRATION_NUMBER`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `BOOKINGFK4` FOREIGN KEY (`DL_NUM`) REFERENCES `customer_details` (`DL_NUMBER`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `BOOKINGFK5` FOREIGN KEY (`INS_CODE`) REFERENCES `rental_car_insurance` (`INSURANCE_CODE`) ON DELETE CASCADE ON UPDATE CASCADE;
